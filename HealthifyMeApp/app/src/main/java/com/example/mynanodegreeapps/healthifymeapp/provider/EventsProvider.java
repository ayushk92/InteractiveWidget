...
import com.example.mynanodegreeapps.healthifymeapp.provider.base.BaseContentProvider;
import com.example.mynanodegreeapps.healthifymeapp.provider.event.EventColumns;

public class EventsProvider extends BaseContentProvider {
    private static final String TAG = EventsProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "com.example.mynanodegreeapps.healthifymeapp.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return EventsSQLiteOpenHelper.getInstance(getContext());
    }
